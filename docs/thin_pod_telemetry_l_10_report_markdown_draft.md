...
- [**2. Background and Requirements**](#2-background-and-requirements)
- [**3. System Design**](#3-system-design)
  - [**3.1 System Architecture**](#31-system-architecture)
  - [**3.2 Hardware Design**](#32-hardware-design)
  - [**3.3 Software Design**](#33-software-design)
  - [**3.4 Risk and Ethical Considerations**](#34-risk-and-ethical-considerations)
- [**4. Methodology and Test Plan**](#4-methodology-and-test-plan)
- [**5. Results**](#5-results)
  - [**5.1 Bring-Up Chronology and Fault Signatures**](#51-bring-up-chronology-and-fault-signatures)
  - [**5.2 Accuracy and Stability**](#52-accuracy-and-stability)
  - [**5.3 Acceptance Testing**](#53-acceptance-testing)
...
- [**Appendix B: Wiring Description (Text)**](#appendix-b-wiring-description-text)
- [**Appendix C: Code Listings (Pointers)**](#appendix-c-code-listings-pointers)
- [**Appendix D: Sample Telemetry CSV (Excerpt)**](#appendix-d-sample-telemetry-csv-excerpt)
